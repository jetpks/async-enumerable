...
module AsyncEnumerable
  # BoundedConcurrency provides a helper method for executing async operations
  # with a maximum fiber limit to prevent unbounded concurrency.
  #
  # This module is included in AsyncEnumerator to provide a consistent way
  # to limit the number of concurrent fibers created during async operations.
  # It uses Async::Semaphore to enforce the fiber limit.
  #
  # @api private
  module BoundedConcurrency
    ...
    # concurrent fibers, creates a barrier under that semaphore, and
    # yields the barrier to the block for spawning async tasks.
    #
    ...
    def max_fibers
      @max_fibers || AsyncEnumerable.max_fibers
    end
  end
end
